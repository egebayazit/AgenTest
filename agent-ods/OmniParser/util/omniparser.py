...
class Omniparser(object):
    ...
    def parse(self, image_base64: str):
        ...
        # 2. İkon Tespit ve Caption Adımı (v2.0)
        # KRİTİK: imgsz=image.size parametresi eklendi.
        dino_labled_img, label_coordinates, parsed_content_list = get_som_labeled_img(
            ...
            scale_img=False, 
            batch_size=128,
            imgsz=image.size  # <-- YENİ: Tam çözünürlük tarama için şart
        )
